...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { age: @instructor.age, first_name: @instructor.first_name, highest_education: @instructor.highest_education, last_name: @instructor.last_name, salary: @instructor.salary } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { age: @instructor.age, first_name: @instructor.first_name, highest_education: @instructor.highest_education, last_name: @instructor.last_name, salary: @instructor.salary } }
